...
public class DropBlockUpperRight extends SequentialCommandGroup {
    ...
    public DropBlockUpperRight(AprilTagSubsystem atSubsystem, DriveTrain driveTrain, Hatch hatch, Elevator elevator, Arm arm, Drawer drawer) {
